<x-public-layout>
    ...
    <!-- Hero Header -->
    <section class="relative py-10 text-center space-y-4 overflow-hidden">
    ...
    <section class="py-10 bg-dark-secondary relative">
        <div class="max-w-4xl mx-auto px-6 space-y-8">
            ...
            <div class="relative border-l border-white/5 pl-8 ml-4 space-y-6">
                <!-- Node 1 -->
                <div class="relative">
    ...
    <section class="py-10 bg-dark-secondary">
                ...
                <table class="w-full text-left border-collapse text-sm">
                    <thead>
                        <tr class="bg-white/5 text-neutral-400 font-semibold border-b border-white/5">
                            ...
                            <th class="px-4 py-2.5">Award Title</th>
                    ...
                    <tbody class="divide-y divide-white/5 text-neutral-300">
                        @foreach($awards as $aw)
                            <tr class="hover:bg-white/5 transition-colors">
                                <td class="px-4 py-2.5 font-mono font-bold text-brand-cyan">{{ $aw['year'] }}</td>
                                <td class="px-4 py-2.5 font-semibold text-white">{{ $aw['title'] }}</td>
                                <td class="px-4 py-2.5 text-neutral-400">{{ $aw['issuer'] }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    <section class="py-10 relative border-t border-b border-white/5">
    ...
    <section class="py-10 relative overflow-hidden bg-dark-secondary">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-6 items-center relative z-10">
    ...
    <section class="py-10 animate-reveal-up">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center max-w-xl mx-auto mb-8 space-y-3">
